...
const REGIONS={
 usa:{n:"United States",x:185,y:168,rel:55,trade:9,bloc:"west",cap:"Washington"},
 canada:{n:"Canada",x:168,y:98,rel:70,trade:5,bloc:"west",cap:"Ottawa"},
 southam:{n:"South America",x:255,y:330,rel:25,trade:4,bloc:"south",cap:"Brasília"},
 uk:{n:"United Kingdom",x:424,y:124,rel:100,trade:10,bloc:"home",cap:"London",home:true},
 france:{n:"France",x:438,y:163,rel:38,trade:7,bloc:"eu",cap:"Paris"},
 germany:{n:"Germany",x:472,y:142,rel:42,trade:8,bloc:"eu",cap:"Berlin"},
 eunorth:{n:"Nordics & Baltics",x:487,y:92,rel:55,trade:6,bloc:"eu",cap:"Stockholm"},
 eusouth:{n:"Southern Europe",x:468,y:192,rel:35,trade:6,bloc:"eu",cap:"Rome"},
 ukraine:{n:"Ukraine",x:535,y:142,rel:60,trade:2,bloc:"east",cap:"Kyiv"},
 russia:{n:"Russia",x:640,y:96,rel:-65,trade:1,bloc:"east",cap:"Moscow"},
 mideast:{n:"Middle East",x:560,y:215,rel:15,trade:5,bloc:"south",cap:"Riyadh"},
 gulf:{n:"The Gulf",x:594,y:243,rel:30,trade:6,bloc:"south",cap:"Abu Dhabi"},
 africaN:{n:"North Africa",x:462,y:248,rel:18,trade:3,bloc:"south",cap:"Cairo"},
 africaS:{n:"Sub-Saharan Africa",x:500,y:340,rel:28,trade:3,bloc:"south",cap:"Nairobi"},
 india:{n:"India",x:662,y:248,rel:35,trade:6,bloc:"south",cap:"Delhi"},
 china:{n:"China",x:742,y:182,rel:5,trade:8,bloc:"east",cap:"Beijing"},
 eastasia:{n:"Japan & Korea",x:826,y:172,rel:50,trade:7,bloc:"west",cap:"Tokyo"},
 oceania:{n:"Australia & NZ",x:842,y:372,rel:72,trade:4,bloc:"west",cap:"Canberra"},
 southatl:{n:"South Atlantic",x:330,y:425,rel:100,trade:1,bloc:"home",cap:"Port Sandwick",tiny:true},
};
/* low-poly continent blobs for the board (purely decorative) */
const MAP_BLOBS=[
